        ...
        <div class="dashboard-stack">
          <article class="card">
            <header class="card__header">
              ...
              <a href="section.html?view=tickets">
                Ver todos
              </a>
            </header>
          ...
          <section class="two-column-grid">
            <article class="card">
              <header class="card__header">
                ...
                <a href="section.html?view=inventory">
                  Inventario
                </a>
              </header>
            ...
            <article class="card">
              <header class="card__header">
                ...
                <a href="section.html?view=calendar">
                  Calendario
                </a>
              </header>
